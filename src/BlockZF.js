...
({
	initBlock: function (bigBlock)
	{
	    ...
	    bigBlock.addChild(bigBlock.b1);
	  	...
	  	{
	      	if (bigBlock.pat%2 == 0 &&  bigBlock.checkSmallBlock(0,1) && bigBlock.checkSmallBlock(1,-0) && bigBlock.checkSmallBlock(1,-1))
	      	{
	      		bigBlock.b2.setPos(0,1);
	      		bigBlock.b3.setPos(1,0);
	      		bigBlock.b4.setPos(1,-1);
	      	}
	      	else if (bigBlock.pat%2 == 1 && bigBlock.checkSmallBlock(-1,0) && bigBlock.checkSmallBlock(0,1) && bigBlock.checkSmallBlock(1,1))
	      	{
