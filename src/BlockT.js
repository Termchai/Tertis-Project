...
({
	initBlock: function (bigBlock)
	{
	    ...
	    bigBlock.addChild(bigBlock.b1);
	  	...
	  	{
	      	if (bigBlock.pat%4 == 0  && bigBlock.checkSmallBlock(0,-1))
	      	{
	      		bigBlock.b3.setPos(0,-1);
	      	}
	      	else if (bigBlock.pat%4 == 1  && bigBlock.checkSmallBlock(-1,0))
	      	{
	      	...
	      	else if (bigBlock.pat%4 == 3 && bigBlock.checkSmallBlock(0, 0) && 
