	    ...
	    bigBlock.addChild(bigBlock.b1);
	  	...
	  	bigBlock.rotation = function()
	  	{
	      		...
	      		bigBlock.checkSmallBlock(2,0))
	      	{
	      		...
	      		bigBlock.b4.setPos(2,0);
	      	}
	      	else if (bigBlock.pat%2 == 1&& bigBlock.checkSmallBlock(0,-1) && bigBlock.checkSmallBlock(0,1) && bigBlock.checkSmallBlock(0,2))
	      	{
	      		bigBlock.b2.setPos(0,-1);
	      		bigBlock.b3.setPos(0,1);
	      		bigBlock.b4.setPos(0,2);
	      	}
	      	else
	      		return;
	      	bigBlock.pat++;
